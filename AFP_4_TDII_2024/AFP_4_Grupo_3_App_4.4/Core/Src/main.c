...
int main(void)
{
  ...
  uint16_t vector_frecuencias[OPCIONES_FRECUENCIA] = {100, 250, 500, 1000};
  uint8_t frecuencia_actual = 0;

  delay_t timer_secuencia;
  delayInit(&timer_secuencia, vector_frecuencias[frecuencia_actual]);
  ...
  while (1)
  {
	  ...
	  if(readKey()){
		  ...
		  delayWrite(&timer_secuencia, vector_frecuencias[frecuencia_actual]);
	  }
